package com.fingerprint.codegen.server;
...
public class FpserverGenerator extends DefaultCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    private static final Logger LOGGER = LoggerFactory.getLogger(FpserverGenerator.class);
    ...
    public FpserverGenerator() {
        ...
        embeddedTemplateDir = templateDir = "fpserver";
    ...
    public String getHelp() {
        return "Generates a Fingerprint Java server library.";
    }
    ...
    public CodegenModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        ...
        if (allDefinitions != null && codegenModel != null && codegenModel.parentSchema != null && codegenModel.hasEnums) {
            ...
            codegenModel = FpserverGenerator.reconcileInlineEnums(codegenModel, parentCodegenModel);
        }
